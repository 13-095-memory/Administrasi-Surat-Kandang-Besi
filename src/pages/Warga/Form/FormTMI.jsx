...
export default function FormTMI() {
  ...
  const [formData, setFormData] = useState({
    ...
    pekerjaan: '',
    alamatLengkap: '',
    alasanTMI: '', // Contoh: Hilang, Rusak, atau Memang Tidak Sekolah
    keperluan: '',
    fotoKtp: null,
    fotoKk: null
  });
    ...
    <div className="bg-[#F8FAFC] min-h-screen pb-12 text-left">
      ...
      <div className="bg-[#1E3A8A] text-white p-6 mb-8 shadow-md">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold uppercase tracking-wide">Surat Keterangan TMI</h1>
            <p className="text-sm opacity-80 text-blue-100">Surat Pernyataan/Keterangan Tidak Memiliki Ijazah</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="bg-white py-4 px-8 border-b border-slate-100 text-center">
          <h2 className="text-[#1E3A8A] font-bold text-lg uppercase tracking-wider">Formulir Keterangan Ijazah</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-10 text-slate-700">
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-1.5 md:col-span-2">
                ...
                <input type="text" placeholder="Masukkan nama sesuai identitas" className="p-3 rounded-xl border border-slate-200 focus:border-blue-500 outline-none" required 
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input type="text" placeholder="Contoh: Petani / Wiraswasta" className="p-3 rounded-xl border border-slate-200 focus:border-blue-500 outline-none" required 
                  onChange={(e) => setFormData({...formData, pekerjaan: e.target.value})} />
              </div>

              <div className="flex flex-col gap-1.5 md:col-span-2">
                <label className="text-sm font-semibold text-[#1E3A8A]">Alamat Lengkap <span className="text-red-500">*</span></label>
                <textarea className="p-3 rounded-xl border border-slate-200 focus:border-blue-500 outline-none" rows="2" placeholder="Masukkan alamat lengkap sesuai KTP" required 
          ...
          <section className="space-y-6 pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-1.5 md:col-span-2">
                <label className="text-sm font-semibold text-[#1E3A8A]">Alasan Tidak Memiliki Ijazah <span className="text-red-500">*</span></label>
                <input type="text" placeholder="Contoh: Ijazah hilang saat banjir / Tidak menempuh sekolah formal" className="p-3 rounded-xl border border-slate-200 focus:border-blue-500 outline-none" required 
                  onChange={(e) => setFormData({...formData, alasanTMI: e.target.value})} />
              </div>
              <div className="flex flex-col gap-1.5 md:col-span-2">
                <label className="text-sm font-semibold text-[#1E3A8A]">Keperluan Surat <span className="text-red-500">*</span></label>
                <input type="text" placeholder="Contoh: Persyaratan pendaftaran bantuan mandiri" className="p-3 rounded-xl border border-slate-200 focus:border-blue-500 outline-none" required 
          ...
          <section className="space-y-6 pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-[#1E3A8A]">Unggah Kartu Keluarga <span className="text-red-500">*</span></label>
                <div className="border-2 border-dashed border-blue-100 rounded-xl p-4 bg-blue-50/30">
                  <input type="file" required accept="image/*" className="text-xs file:mr-2 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-[#1E3A8A] file:text-white cursor-pointer" 
